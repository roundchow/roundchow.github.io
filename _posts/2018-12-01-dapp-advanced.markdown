...
## Part4-使用 etherscan 和 remix 查看和测试合约实例
...
## Part5-使用 mocha + web3.js + ganache 编写合约测试
...
到这里，我们熟悉了智能合约编译、部署、测试工作流，并且能用前端的知识把他们串起来，尽可能自动化，同时我们也熟悉了 web3.js 的基本用法，接下来我们会基于已经熟悉和掌握的工具、方法去做点有意思的东西！
